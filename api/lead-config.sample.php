...
return [
    ...
    // Куди дублювати заявку листом. У коді адреси немає навмисно: репозиторій
    // публічний, і звідти вона поїхала б у спам-бази. Кладе цей рядок деплой
    // із секрету LEAD_NOTIFY_EMAIL.
    //
    // Порожньо — листи просто не шлються, на заявки це не впливає ніяк: лист
    // нічого не підтверджує і у відповідь сторінці не потрапляє.
    'notify_email' => '',
];
